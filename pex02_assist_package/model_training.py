...
def train_model(amt_data=1.0):
    ...
    samples_fix = data_gen.get_sequence_samples(DATA_PATH_FIX, sequence_size=13)
    samples_l = data_gen.get_sequence_samples(DATA_PATH_L, sequence_size=13)
    samples_r = data_gen.get_sequence_samples(DATA_PATH_R, sequence_size=13)
    samples = samples_l + samples_r + samples_fix
